...
public:
    sdl2_window()
    {
        ...
        yorcvs::log(std::string("======SDL2 Version=======\nUsing SDL2 rendering\n") + "COMPILED with SDL2 version: " + std::to_string(SDL_MAJOR_VERSION) + ' ' + std::to_string(SDL_MINOR_VERSION) + ' ' + std::to_string(SDL_PATCHLEVEL) + '\n' + "LINKED SDL2 version: " + std::to_string(sdlversion.major) + ' ' + std::to_string(sdlversion.minor) + ' ' + std::to_string(sdlversion.patch) + '\n' + "COMPILED with SDL2_image version : " + std::to_string(SDL_IMAGE_MAJOR_VERSION) + ' ' + std::to_string(SDL_IMAGE_MINOR_VERSION) + ' ' + std::to_string(SDL_IMAGE_PATCHLEVEL) + '\n' + "LINKED SDL2_image version : " + std::to_string(sdlimageversion->major) + ' ' + std::to_string(sdlimageversion->minor) + ' ' + std::to_string(sdlimageversion->patch) + '\n' + "COMPILED with SDL2_ttf version : " + std::to_string(SDL_TTF_COMPILEDVERSION) + '\n' + "LINKED with SDL2_ttf version: " + std::to_string(sdlttfversion->major) + ' ' + std::to_string(sdlttfversion->minor) + ' ' + std::to_string(sdlttfversion->patch) + '\n' + "=============\n ",
